...
const TeamGameRow = (props) => {
    const { row, team } = props;
                    ...
                    <TableBody>
                        ...
                        <TableRow key={game._id }>
                            ...
                            <TableCell align="right">
                                {game.teams[0].city === team.city ? <Link to={`/teams/${game.teams[1].id}`}>{`${game.teams[1].city}`}</Link> : <Link to={`/teams/${game.teams[0].id}`}>{`${game.teams[0].city}`}</Link> }
                            </TableCell>
